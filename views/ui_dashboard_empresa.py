...
class UIDashboardEmpresa(ttk.Frame):
    ...
    _NAV = [
        ...
        ("gestion_documental", "\u25a4", "Gestion documental", "gestion_documental"),
        ("ocr",            "\u25ce", "OCR de facturas",    "ocr"),
    ...
    def __init__(
        ...
        *,
        ...
        on_open_ocr,
        on_open_gestion_documental=None,
        ...
        self._callbacks = {
            ...
            "ocr":             on_open_ocr,
            "gestion_documental": on_open_gestion_documental or (lambda: None),
