class MessagingGroup {
  const MessagingGroup({required this.id, required this.name, required this.type, required this.members});
...
class GroupMember {
  const GroupMember({required this.id, required this.memberType, required this.memberId, required this.role});
