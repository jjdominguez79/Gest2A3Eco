const CACHE='gestinem-messaging-v1';
const ASSETS=['/mensajes','/static/messaging.css','/static/messaging.js','/static/messaging.webmanifest','/static/messaging-icon.svg'];
