const CACHE='gestinem-messaging-v4';
const ASSETS=['/mensajes','/static/messaging.css?v=3','/static/messaging.js','/static/messaging.webmanifest','/static/gestinem-logo.png'];
