...
CREATE TABLE dgt_documentos (id uuid PRIMARY KEY, expediente_id uuid NOT NULL REFERENCES dgt_expedientes(id) ON DELETE CASCADE, rol varchar(16) NOT NULL, tipo varchar(64) NOT NULL, nombre_archivo varchar(255) NOT NULL, storage_key varchar(500) UNIQUE NOT NULL, content_type varchar(100) NOT NULL, size integer NOT NULL, sha256 char(64) NOT NULL, created_at timestamptz NOT NULL DEFAULT now());
