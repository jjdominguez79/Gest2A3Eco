...
CREATE TABLE IF NOT EXISTS msg_campaigns (id varchar(36) PRIMARY KEY, name varchar(160) NOT NULL, body text NOT NULL, channel varchar(20) NOT NULL DEFAULT 'general', created_by varchar(64) NOT NULL, status varchar(20) NOT NULL DEFAULT 'draft', created_at timestamptz NOT NULL DEFAULT now(), scheduled_at timestamptz, sent_at timestamptz);
