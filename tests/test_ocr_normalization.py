...
def test_normalizacion_backend_caso_real():
    ...
    doc = SimpleNamespace(fields={
        ...
        "ClienteNif":      _field_string("B12345678"),
        "ClienteNombre":   _field_string("Cliente Destino SL"),
    ...
    assert result["cliente_nif"]    == "B12345678"
    assert result["cliente_nombre"] == "Cliente Destino SL"
...
def test_normalizacion_campos_no_existen():
    ...
    doc = SimpleNamespace(fields={})
    result = _mapear_documento(doc, model_id="modelo-servidor")
...
def test_normalizacion_to_dict_contrato():
    ...
    d = _mapear_documento(doc, model_id="facturas-produccion-v1")
    for campo in ("proveedor_nif", "cliente_nif", "cliente_nombre", "numero_factura", "fecha_factura",
