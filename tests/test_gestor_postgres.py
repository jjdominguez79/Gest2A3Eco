...
_COLUMNAS_ESENCIALES = {
    ...
    ("cert_solicitudes", "area_cliente_documento_id"),
    ("cert_solicitudes", "area_cliente_version"),
    ("cert_solicitudes", "area_cliente_error"),
    ("cert_solicitudes", "fecha_publicacion_cliente"),
    ("notif_bandeja", "area_cliente_documento_id"),
    ("notif_bandeja", "area_cliente_version"),
    ("notif_bandeja", "area_cliente_error"),
    ("notif_bandeja", "email_cliente_estado"),
    ("notif_bandeja", "email_cliente_fecha"),
    ("notif_bandeja", "email_cliente_error"),
