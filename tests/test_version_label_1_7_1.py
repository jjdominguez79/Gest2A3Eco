"""
Tests de version y etiqueta de pantalla de acceso — v1.7.1.
...
5. views/ui_auth.py no contiene "1.7.1" hardcodeado directamente.
...
def test_ui_auth_no_tiene_version_hardcodeada():
    ...
    assert "1.7.1" not in contenido, (
        "views/ui_auth.py no debe contener la version '1.7.1' hardcodeada"
    )
